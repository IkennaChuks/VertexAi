...
def __load_model():
    ...
    model.load_model("artifacts/xgboost_coupon_recommendation.json")
    return model

def load_model():
    storage_client = storage.Client()
    bucket_name = "vertexai-demo-2025"
    bucket = storage_client.bucket(bucket_name)
    blob = bucket.blob("ml-artifacts/xgboost_coupon_recommendation.json")
    local_path = "xgboost_coupon_recommendation.json"
